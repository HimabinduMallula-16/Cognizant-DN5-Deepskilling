...
public List<EmployeeView> projection(){
    ...
    return service.getEmployeeView();
...
public Page<Employee> getEmployeesPage(
    ...
    return service.getEmployeesPage(pageable);
}
@GetMapping("/sort")
public List<Employee> sortEmployees(
        @RequestParam(defaultValue = "name") String field) {
...
public Page<Employee> pageSortEmployees(
    ...
    return service.getEmployeesPageSorted(page, size, field);
}
